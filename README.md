![logo](https://github.com/curated-intel/Log4Shell-IOCs/blob/main/ci-logo.png)
...
| Gh0st RAT           | Attack tool usage              | [Gh0st RAT (Malware Family) (fraunhofer.de)](https://malpedia.caad.fkie.fraunhofer.de/details/win.ghost_rat)       | [Gh0st RAT, Software S0032](https://attack.mitre.org/software/S0032/)     | [Remote Access Software, Technique T1219](https://attack.mitre.org/techniques/T1219/)                                                |
...
| Organized Cybercrime | Russia | Prophet Spider | UNC961 | [BlackBerry](https://blogs.blackberry.com/en/2022/01/log4u-shell4me) | The Initial Access Broker (IAB) group Prophet Spider has been exploiting the Log4j vulnerability in the Apache Tomcat component of VMware Horizon |
